...
describe('+ encode(input)', function() {
  describe('> when input a byte array', function() {
    it('should convert to the base58 encoding', function() {
      ...
      var privateKeyWIF = base58.encode(new Buffer(privateKeyAndChecksum, 'hex'));
      ...
      var address = base58.encode(new Buffer(unencodedAddress, 'hex'));
  ...
  describe('> when input a buffer', function() {
    it('should convert to the base58 encoding', function() {
      ...
      var b = new Buffer(unencodedData, 'hex');
